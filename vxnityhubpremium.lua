	...
	task.defer(function()
		pcall(function()
			game:GetService("StarterGui"):SetCore("SendNotification", {
				Title = "VxnityHub";
				Text = "Se ha aplicado correctamente el bypass, disfrute de su script premium.";
				Duration = 10;
			})
		end)
	end)
...
do
	...
	local SectionMethod3 = createSection(TabReach, "Reach Method 2 (Ball Reach)")
	
	addToggle(
		SectionMethod3,
		"Enable / Disable Ball Reach",
		false,
		"Invisible extended touch range from ball (Max 8)",
		function(value)
			Reach3Enabled = value
			if value then
